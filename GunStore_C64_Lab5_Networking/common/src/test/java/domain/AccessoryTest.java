...
public class AccessoryTest {
    ...
    @BeforeAll
    static void init() {
        accessory = new GunAccessories(ID, NAME, TYPE, COMPANY, PRICE);
    }
    ...
    public void testEquals() {
        accessory = new GunAccessories(ID, NAME, TYPE, COMPANY, PRICE);
        GunAccessories accessory2 =new GunAccessories(ID, NAME, TYPE, COMPANY, PRICE);
        assertEquals(accessory, accessory2);

        GunAccessories accessory3 = new GunAccessories(ID, NEW_NAME, TYPE, COMPANY, PRICE);
    ...
    public void testReadEntities() {
        ...
        GunAccessories testAccessory2 = new GunAccessories(99L,"testName","testType","testCompany",99);
