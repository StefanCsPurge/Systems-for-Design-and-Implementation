...
public class GunTest {
    ...
    @BeforeAll
    static void init() {
        gun = new Gun(ID, MODEL, MANUFACTURER, TYPE, WEIGHT, PRICE);
    }
    ...
    public void testEquals() {
        gun = new Gun(ID, MODEL, MANUFACTURER, TYPE, WEIGHT, PRICE);
        Gun gun2 = new Gun(ID, MODEL, MANUFACTURER, TYPE, WEIGHT, PRICE);
        assertEquals(gun, gun2);

        Gun gun3 = new Gun(ID, NEW_MODEL, MANUFACTURER, TYPE, WEIGHT, PRICE);
    ...
    public void testCSVString() {
        String test_string = ID + "," + MODEL + "," + MANUFACTURER + "," + TYPE + "," + WEIGHT + "," + PRICE;
        String gun_string = gun.getCSVString();
        assertEquals(test_string, gun_string);
    }
    ...
    public void testReadEntities() {
        Gun testGun = new Gun();
        Gun testGun2 = new Gun(99L,"testModel","testManufacturer","testType",99,99);
