...
public class AmmunitionTest {
    ...
    @BeforeAll
    static void init() {
        ammunition = new Ammunition(ROUNDS, CALIBER, MANUFACTURER, PRICE);
    }
    ...
    public void testEquals() {
        ammunition = new Ammunition(ROUNDS, CALIBER, MANUFACTURER, PRICE);
        Ammunition ammunition2 = new Ammunition(ROUNDS, CALIBER, MANUFACTURER, PRICE);
        assertEquals(ammunition, ammunition2);

        Ammunition ammunition3 = new Ammunition(NEW_ROUNDS, NEW_CALIBER, NEW_MANUFACTURER, NEW_PRICE);
    ...
    public void testReadEntities() {
        ...
        Ammunition testammunition2 = new Ammunition(100,300,"testManufacturer",99);
